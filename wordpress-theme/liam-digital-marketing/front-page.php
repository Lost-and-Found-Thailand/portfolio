    ...
    <div class="ldm-trustbar-viewport">
      <div class="ldm-trustbar-track">
          <div class="ldm-trustbar-set">
            ...
            <span class="ldm-trustbar-logo ldm-trustbar-logo--md"><img src="<?php echo esc_url( $ldm_img . '/assets/img/clients/united-pharma.png' ); ?>" alt="<?php esc_attr_e( 'United Pharma', 'liam-digital-marketing' ); ?>" width="781" height="607" loading="lazy"></span>
          </div>
