...
?>
  ...
  <section class="ldm-section container" id="services">
    ...
    <div class="ldm-services-grid reveal">
      ...
      <div class="ldm-service">
        ...
        <p>AEO, AIO, GEO, ACO and SEM, so content gets found and cited across AI-driven search, not just traditional rankings.</p>
      </div>
    </div>
  </section>
  ...
  <section class="ldm-section container" id="skills-tools">
    ...
    <div class="ldm-tech-grid reveal">
      ...
      <div class="ldm-tech-cat">
        <h4>Tracking</h4>
        <div class="ldm-tech-pills"><span class="tag">Google Tag Manager</span><span class="tag">Meta Pixel</span><span class="tag">Conversion Tracking</span><span class="tag">Server-side Tracking</span><span class="tag">Stape.io</span></div>
      </div>
      <div class="ldm-tech-cat">
      ...
      <div class="ldm-tech-cat">
        <h4>Websites</h4>
        <div class="ldm-tech-pills"><span class="tag">WordPress</span><span class="tag">Lovable</span><span class="tag">Landing Pages</span><span class="tag">Conversion Optimization</span></div>
      </div>
      <div class="ldm-tech-cat">
        <h4>E-commerce</h4>
        <div class="ldm-tech-pills"><span class="tag">Shopify</span><span class="tag">WooCommerce</span><span class="tag">Shopee</span><span class="tag">Lazada</span><span class="tag">Google Merchant Center</span></div>
      </div>
      <div class="ldm-tech-cat">
        <h4>AI Tools</h4>
        <div class="ldm-tech-pills"><span class="tag">Claude</span><span class="tag">ChatGPT</span><span class="tag">Cursor</span><span class="tag">Perplexity</span></div>
      </div>
    </div>
  </section>
