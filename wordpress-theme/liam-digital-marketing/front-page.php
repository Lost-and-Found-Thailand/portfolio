...
?>
  ...
  <!-- 09 NEON FLOW -->
  <section class="ldm-section container" id="neon-flow">
    <div class="ldm-section-head reveal">
      <span class="eyebrow">A Bit Of Fun</span>
      <h2 class="fs-h2">When the work's done, there's room to play.</h2>
      <p class="lede">Move your cursor to explore. Click to shift the colors.</p>
    </div>
    <div class="ldm-neon-flow reveal" data-neon-flow>
      <canvas class="ldm-neon-flow-canvas" aria-hidden="true"></canvas>
      <span class="ldm-neon-flow-title" aria-hidden="true">Neon Flow</span>
    </div>
  </section>
