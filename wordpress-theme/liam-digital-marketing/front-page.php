    ...
    <div class="ldm-trustbar-viewport">
      <div class="ldm-trustbar-track">
          <div class="ldm-trustbar-set">
            ...
            <span class="ldm-trustbar-logo ldm-trustbar-logo--xs2"><img src="<?php echo esc_url( $ldm_img . '/assets/img/clients/unity.png' ); ?>" alt="<?php esc_attr_e( 'U.N.I.T.Y', 'liam-digital-marketing' ); ?>" width="372" height="76" loading="lazy"></span>
            ...
            <span class="ldm-trustbar-logo ldm-trustbar-logo--xs"><img src="<?php echo esc_url( $ldm_img . '/assets/img/clients/cave-rai-ra-trustbar.png' ); ?>" alt="<?php esc_attr_e( 'Cave Rai Ra', 'liam-digital-marketing' ); ?>" width="1616" height="309" loading="lazy"></span>
            <span class="ldm-trustbar-logo ldm-trustbar-logo--md"><img src="<?php echo esc_url( $ldm_img . '/assets/img/clients/simple-financial-trustbar.png' ); ?>" alt="<?php esc_attr_e( 'Simple Financial', 'liam-digital-marketing' ); ?>" width="1073" height="720" loading="lazy"></span>
          </div>
    ...
    <div class="ldm-case-list">
      ...
      <a href="<?php echo esc_url( ldm_case_study_url( 'ours-group' ) ); ?>" class="ldm-case reveal">
        ...
        <div class="ldm-case-body">
          ...
          <div class="ldm-case-industry">Performance Marketing &middot; Analytics &middot; Conversion Tracking</div>
          <p class="ldm-case-desc">One shared tracking system spans seven Uluwatu venues: Tabu Supper Club, AMA by Ours, Ours Uluwatu, Ours Spa, Home by Ours, Mood by Ours and The Beach by Ours. It's built to prove which campaigns actually drive bookings at each address.</p>
  ...
  <section class="ldm-section container" id="services">
    ...
    <div class="ldm-services-grid reveal">
      <div class="ldm-service">
        ...
        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M5 21V10M12 21V4M19 21v-7"/></svg>
        <h3>Paid Media</h3>
      ...
      <div class="ldm-service">
        ...
        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="3.5"/></svg>
        <h3>Conversion Tracking</h3>
        <p>GA4, Google Tag Manager, Meta Pixel, conversion APIs and event tracking.</p>
      </div>
      <div class="ldm-service">
        <div class="index">04</div>
        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M4 17l5-5 4 4 7-9"/><path d="M15 7h5v5"/></svg>
        <h3>Marketing Analytics</h3>
        <p>Measurement systems, dashboards, attribution and campaign analysis.</p>
      </div>
      <div class="ldm-service">
        <div class="index">05</div>
        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M5 3l6 16 2.2-6.4L20 10.4z"/></svg>
        <h3>Conversion Optimization</h3>
        <p>Landing pages, forms, funnels and conversion journeys that perform.</p>
      </div>
      <div class="ldm-service">
        <div class="index">06</div>
        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="M15.5 8.5l-2 5-5 2 2-5z"/></svg>
      ...
      <div class="ldm-service">
        ...
        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 3l1.8 4.8L18.5 9l-4.7 1.2L12 15l-1.8-4.8L5.5 9l4.7-1.2z"/><path d="M19 15l.9 2.4L22 18l-2.1.6L19 21l-.9-2.4L16 18l2.1-.6z"/></svg>
  ...
  <section class="ldm-section container" id="skills-tools">
    ...
    <div class="ldm-tech-grid reveal">
      <div class="ldm-tech-cat">
        <h4>Advertising</h4>
        <div class="ldm-tech-pills"><span class="tag">Meta Ads</span><span class="tag">Google Ads</span><span class="tag">TikTok Ads</span><span class="tag">LinkedIn Ads</span><span class="tag">Telegram Ads</span><span class="tag">X Ads</span><span class="tag">Pinterest Ads</span><span class="tag">Snapchat Ads</span><span class="tag">Performance Max</span><span class="tag">Google Search</span></div>
      </div>
      <div class="ldm-tech-cat">
        <h4>Analytics</h4>
        <div class="ldm-tech-pills"><span class="tag">GA4</span><span class="tag">Looker Studio</span><span class="tag">Google Analytics</span><span class="tag">Attribution Modeling</span><span class="tag">Data Visualization</span><span class="tag">BigQuery</span><span class="tag">Mixpanel</span><span class="tag">Amplitude</span></div>
      </div>
      <div class="ldm-tech-cat">
        <h4>Tracking</h4>
        <div class="ldm-tech-pills"><span class="tag">Google Tag Manager</span><span class="tag">Meta Pixel</span><span class="tag">Conversion Tracking</span><span class="tag">Server-side Tracking</span><span class="tag">Stape.io</span><span class="tag">Segment</span></div>
      </div>
      <div class="ldm-tech-cat">
        <h4>CRM / Automation</h4>
        <div class="ldm-tech-pills"><span class="tag">HubSpot</span><span class="tag">Lead Management</span><span class="tag">Marketing Automation</span><span class="tag">CRM Integration</span><span class="tag">Zapier</span><span class="tag">Make</span><span class="tag">Klaviyo</span><span class="tag">ActiveCampaign</span></div>
      </div>
      <div class="ldm-tech-cat">
        <h4>Websites</h4>
        <div class="ldm-tech-pills"><span class="tag">WordPress</span><span class="tag">Lovable</span><span class="tag">Webflow</span><span class="tag">Framer</span><span class="tag">Landing Pages</span><span class="tag">Conversion Optimization</span></div>
      </div>
      <div class="ldm-tech-cat">
        <h4>E-commerce</h4>
        <div class="ldm-tech-pills"><span class="tag">Shopify</span><span class="tag">WooCommerce</span><span class="tag">Shopee</span><span class="tag">Lazada</span><span class="tag">Amazon</span><span class="tag">Google Merchant Center</span></div>
      </div>
      <div class="ldm-tech-cat">
        <h4>AI Tools</h4>
        <div class="ldm-tech-pills"><span class="tag">Claude</span><span class="tag">ChatGPT</span><span class="tag">Gemini</span><span class="tag">Cursor</span><span class="tag">Perplexity</span><span class="tag">Midjourney</span><span class="tag">n8n</span></div>
      </div>
    </div>
  </section>
