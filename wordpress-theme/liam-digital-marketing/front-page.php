    ...
    <div class="ldm-trustbar-viewport">
      <div class="ldm-trustbar-track">
          <div class="ldm-trustbar-set">
            ...
            <span class="ldm-trustbar-logo ldm-trustbar-logo--sm2"><img src="<?php echo esc_url( $ldm_img . '/assets/img/clients/royal-finances.png' ); ?>" alt="<?php esc_attr_e( 'Royal Finances', 'liam-digital-marketing' ); ?>" width="724" height="328" loading="lazy"></span>
