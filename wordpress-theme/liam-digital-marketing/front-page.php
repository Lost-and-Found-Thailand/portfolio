    ...
    <div class="ldm-trustbar-viewport">
      <div class="ldm-trustbar-track">
          <div class="ldm-trustbar-set">
            ...
            <span class="ldm-trustbar-logo ldm-trustbar-logo--sm"><img src="<?php echo esc_url( $ldm_img . '/assets/img/clients/paracetamol-biogesic.png' ); ?>" alt="<?php esc_attr_e( 'Paracetamol Biogesic', 'liam-digital-marketing' ); ?>" width="480" height="191" loading="lazy"></span>
            <span class="ldm-trustbar-logo ldm-trustbar-logo--sm2"><img src="<?php echo esc_url( $ldm_img . '/assets/img/clients/bbb.png' ); ?>" alt="<?php esc_attr_e( 'BB&amp;B', 'liam-digital-marketing' ); ?>" width="894" height="440" loading="lazy"></span>
            ...
            <span class="ldm-trustbar-logo ldm-trustbar-logo--md"><img src="<?php echo esc_url( $ldm_img . '/assets/img/clients/united-pharma.png' ); ?>" alt="<?php esc_attr_e( 'United Pharma', 'liam-digital-marketing' ); ?>" width="400" height="351" loading="lazy"></span>
          </div>
