    ...
    <div class="ldm-trustbar-viewport">
      <div class="ldm-trustbar-track">
          <div class="ldm-trustbar-set">
            <span class="ldm-trustbar-logo"><img src="<?php echo esc_url( $ldm_img . '/assets/img/clients/hakkasan.png' ); ?>" alt="<?php esc_attr_e( 'Hakkasan', 'liam-digital-marketing' ); ?>" width="105" height="56" loading="lazy"></span>
            <span class="ldm-trustbar-logo"><img src="<?php echo esc_url( $ldm_img . '/assets/img/clients/savaya.png' ); ?>" alt="<?php esc_attr_e( 'Savaya', 'liam-digital-marketing' ); ?>" width="89" height="64" loading="lazy"></span>
            <span class="ldm-trustbar-logo"><img src="<?php echo esc_url( $ldm_img . '/assets/img/clients/yona-beach-club.png' ); ?>" alt="<?php esc_attr_e( 'Yona Beach Club', 'liam-digital-marketing' ); ?>" width="102" height="51" loading="lazy"></span>
            <span class="ldm-trustbar-logo"><img src="<?php echo esc_url( $ldm_img . '/assets/img/clients/bmw.png' ); ?>" alt="<?php esc_attr_e( 'BMW', 'liam-digital-marketing' ); ?>" width="97" height="97" loading="lazy"></span>
            <span class="ldm-trustbar-logo"><img src="<?php echo esc_url( $ldm_img . '/assets/img/clients/hp.png' ); ?>" alt="<?php esc_attr_e( 'HP', 'liam-digital-marketing' ); ?>" width="74" height="74" loading="lazy"></span>
            <span class="ldm-trustbar-logo"><img src="<?php echo esc_url( $ldm_img . '/assets/img/clients/northstar-brokers.png' ); ?>" alt="<?php esc_attr_e( 'Northstar Brokers', 'liam-digital-marketing' ); ?>" width="162" height="36" loading="lazy"></span>
            <span class="ldm-trustbar-logo"><img src="<?php echo esc_url( $ldm_img . '/assets/img/clients/tabu-supper-club.png' ); ?>" alt="<?php esc_attr_e( 'Tabu Supper Club', 'liam-digital-marketing' ); ?>" width="162" height="57" loading="lazy"></span>
            <span class="ldm-trustbar-logo"><img src="<?php echo esc_url( $ldm_img . '/assets/img/clients/papas-deli.png' ); ?>" alt="<?php esc_attr_e( 'Papa\'s Deli', 'liam-digital-marketing' ); ?>" width="100" height="28" loading="lazy"></span>
            <span class="ldm-trustbar-logo"><img src="<?php echo esc_url( $ldm_img . '/assets/img/clients/beach-house-by-ours.png' ); ?>" alt="<?php esc_attr_e( 'The Beach House by Ours', 'liam-digital-marketing' ); ?>" width="163" height="113" loading="lazy"></span>
            <span class="ldm-trustbar-logo"><img src="<?php echo esc_url( $ldm_img . '/assets/img/clients/ours.png' ); ?>" alt="<?php esc_attr_e( 'Ours', 'liam-digital-marketing' ); ?>" width="136" height="28" loading="lazy"></span>
            <span class="ldm-trustbar-logo"><img src="<?php echo esc_url( $ldm_img . '/assets/img/clients/bollywood-phuket.png' ); ?>" alt="<?php esc_attr_e( 'Bollywood Phuket', 'liam-digital-marketing' ); ?>" width="145" height="72" loading="lazy"></span>
            <span class="ldm-trustbar-logo"><img src="<?php echo esc_url( $ldm_img . '/assets/img/clients/ama.png' ); ?>" alt="<?php esc_attr_e( 'AMA', 'liam-digital-marketing' ); ?>" width="163" height="72" loading="lazy"></span>
            <span class="ldm-trustbar-logo"><img src="<?php echo esc_url( $ldm_img . '/assets/img/clients/british-american-tobacco.png' ); ?>" alt="<?php esc_attr_e( 'British American Tobacco', 'liam-digital-marketing' ); ?>" width="121" height="64" loading="lazy"></span>
            <span class="ldm-trustbar-logo"><img src="<?php echo esc_url( $ldm_img . '/assets/img/clients/hype-boat-club.png' ); ?>" alt="<?php esc_attr_e( 'HYPE Boat Club', 'liam-digital-marketing' ); ?>" width="158" height="60" loading="lazy"></span>
            <span class="ldm-trustbar-logo"><img src="<?php echo esc_url( $ldm_img . '/assets/img/clients/simba-sea-trips.png' ); ?>" alt="<?php esc_attr_e( 'Simba Sea Trips', 'liam-digital-marketing' ); ?>" width="91" height="72" loading="lazy"></span>
            <span class="ldm-trustbar-logo"><img src="<?php echo esc_url( $ldm_img . '/assets/img/clients/air-canada.png' ); ?>" alt="<?php esc_attr_e( 'Air Canada', 'liam-digital-marketing' ); ?>" width="160" height="72" loading="lazy"></span>
            <span class="ldm-trustbar-logo"><img src="<?php echo esc_url( $ldm_img . '/assets/img/clients/omnia-nightclub.png' ); ?>" alt="<?php esc_attr_e( 'Omnia Nightclub', 'liam-digital-marketing' ); ?>" width="150" height="54" loading="lazy"></span>
            <span class="ldm-trustbar-logo"><img src="<?php echo esc_url( $ldm_img . '/assets/img/clients/idt.png' ); ?>" alt="<?php esc_attr_e( 'ID&T', 'liam-digital-marketing' ); ?>" width="110" height="76" loading="lazy"></span>
            <span class="ldm-trustbar-logo"><img src="<?php echo esc_url( $ldm_img . '/assets/img/clients/the-barrel-wine-merchant.png' ); ?>" alt="<?php esc_attr_e( 'The Barrel Wine Merchant', 'liam-digital-marketing' ); ?>" width="99" height="100" loading="lazy"></span>
            <span class="ldm-trustbar-logo"><img src="<?php echo esc_url( $ldm_img . '/assets/img/clients/nh-boat-lagoon.png' ); ?>" alt="<?php esc_attr_e( 'NH Boat Lagoon Phuket Resort', 'liam-digital-marketing' ); ?>" width="121" height="81" loading="lazy"></span>
            <span class="ldm-trustbar-logo"><img src="<?php echo esc_url( $ldm_img . '/assets/img/clients/chalong-bay.png' ); ?>" alt="<?php esc_attr_e( 'Chalong Bay', 'liam-digital-marketing' ); ?>" width="140" height="102" loading="lazy"></span>
            <span class="ldm-trustbar-logo"><img src="<?php echo esc_url( $ldm_img . '/assets/img/clients/bennys.png' ); ?>" alt="<?php esc_attr_e( 'Benny\'s Cocktails & Grill', 'liam-digital-marketing' ); ?>" width="163" height="81" loading="lazy"></span>
            <span class="ldm-trustbar-logo"><img src="<?php echo esc_url( $ldm_img . '/assets/img/clients/cashdepot.png' ); ?>" alt="<?php esc_attr_e( 'CashDepot', 'liam-digital-marketing' ); ?>" width="168" height="25" loading="lazy"></span>
            <span class="ldm-trustbar-logo"><img src="<?php echo esc_url( $ldm_img . '/assets/img/clients/sake-no-hana.png' ); ?>" alt="<?php esc_attr_e( 'Sake no Hana', 'liam-digital-marketing' ); ?>" width="233" height="66" loading="lazy"></span>
            <span class="ldm-trustbar-logo"><img src="<?php echo esc_url( $ldm_img . '/assets/img/clients/carpe-diem-beach-club.png' ); ?>" alt="<?php esc_attr_e( 'Carpe Diem Beach Club', 'liam-digital-marketing' ); ?>" width="299" height="379" loading="lazy"></span>
