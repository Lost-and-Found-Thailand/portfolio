...
function ldm_get_case_studies() {
	return array(
		...
		array( 'slug' => 'tabu-bali', 'name' => 'Tabu Bali', 'badge' => 'Hospitality', 'industry' => null, 'type' => 'Restaurant & Supperclub', 'desc' => null, 'result' => null, 'img' => 'tabu-bali-photo.jpg', 'alt' => 'A real dish spread from Tabu Bali\'s menu', 'href' => null, 'hero_img' => 'tabu-bali-hero.jpg' ),
		array( 'slug' => 'carpe-diem', 'name' => 'Carpe Diem', 'badge' => 'Hospitality', 'industry' => null, 'type' => 'Beach Restaurant, Beach Club, Pool Party', 'desc' => null, 'result' => null, 'img' => 'carpe-diem-photo.jpg', 'alt' => 'The pool bar and sunbeds at Carpe Diem Beach Club', 'href' => null, 'hero_img' => 'carpe-diem-hero.jpg' ),
		array( 'slug' => 'the-beach-by-ours', 'name' => 'The Beach by Ours', 'badge' => 'Hospitality', 'industry' => null, 'type' => 'Beach Restaurant, Beach Club', 'desc' => null, 'result' => null, 'img' => 'the-beach-by-ours-photo.jpg', 'alt' => 'A real dish spread from The Beach by Ours', 'href' => null, 'hero_img' => 'the-beach-by-ours-hero.jpg' ),
		array( 'slug' => 'soho-pool-club', 'name' => 'Soho Pool Club', 'badge' => 'Hospitality', 'industry' => null, 'type' => 'Pool Club', 'desc' => null, 'result' => null, 'img' => 'soho-pool-club-photo.jpg', 'alt' => 'The clubhouse and pool at Soho Pool Club', 'href' => null, 'hero_img' => 'soho-pool-club-hero.jpg' ),
		array( 'slug' => 'marbella-beach-goa', 'name' => 'Marbella Beach Goa', 'badge' => 'Hospitality', 'industry' => null, 'type' => 'Beach Club & Resort', 'desc' => null, 'result' => null, 'img' => 'marbella-beach-goa-photo.jpg', 'alt' => 'The pool deck at Marbella Beach Goa', 'href' => null, 'hero_img' => 'marbella-beach-goa-hero.jpg' ),
		array( 'slug' => 'ama-by-ours', 'name' => 'Ama by Ours', 'badge' => 'Hospitality', 'industry' => null, 'type' => 'Restaurant', 'desc' => null, 'result' => null, 'img' => 'ama-by-ours-photo.jpg', 'alt' => 'A dish spread from Ama by Ours', 'href' => null, 'hero_img' => 'ama-by-ours-hero.jpg' ),
		array( 'slug' => 'bennys-cocktails-grill', 'name' => 'Benny’s Cocktails & Grill', 'badge' => 'Hospitality', 'industry' => null, 'type' => 'Steakhouse, Cocktail Bar', 'desc' => null, 'result' => null, 'img' => 'bennys-cocktails-grill-photo.jpg', 'alt' => 'The dining room at Benny\'s Cocktails & Grill', 'href' => null, 'hero_img' => 'bennys-cocktails-grill-hero.jpg' ),
		array( 'slug' => 'ours-bali', 'name' => 'Ours Bali', 'badge' => 'Hospitality', 'industry' => null, 'type' => 'Restaurant', 'desc' => null, 'result' => null, 'img' => 'ours-bali-photo.jpg', 'alt' => 'A dish spread from Ours Bali', 'href' => null, 'hero_img' => 'ours-bali-hero.jpg' ),
		array( 'slug' => 'home-by-ours', 'name' => 'Home by Ours', 'badge' => 'Hospitality', 'industry' => null, 'type' => 'Restaurant', 'desc' => null, 'result' => null, 'img' => 'home-by-ours-photo.jpg', 'alt' => 'The outdoor dining terrace at Home by Ours', 'href' => null, 'hero_img' => 'home-by-ours-hero.jpg' ),
