...
function ldm_get_case_studies() {
	return array(
		...
		array(
			...
			'type'            => null,
			'desc'            => 'A sunset beachfront setting turned into a steady flow of bookings for tables, day beds and rooms to stay, through paid media and tracking built around exactly what makes The Beach by Ours work.',
			'result'          => '14,842%',
			...
			'strategy_steps'  => array(
				array( 'title' => 'Paid Media', 'desc' => 'Campaigns built around real venue photography and audience targeting suited to The Beach by Ours\' sunset-dining and day bed crowd.' ),
		...
		array(
			...
			'industry'        => 'Performance Marketing &middot; Analytics &middot; Conversion Tracking',
			'type'            => null,
			'desc'            => 'A beachfront profile in Phuket that now converts into a steady stream of bookings, through paid media tuned to what makes Carpe Diem\'s setting distinctive.',
			'result'          => '2,750%',
		...
		array(
			...
			'industry'          => 'Performance Marketing &middot; Analytics &middot; Conversion Tracking',
			'type'              => 'Yoga School',
			'desc'              => 'Multiple campuses, one enrollment funnel: interest in House of Om now converts into qualified enrollments through full-funnel paid media and tracking.',
			'result'            => '2,243%',
