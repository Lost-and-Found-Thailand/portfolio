...
function ldm_get_case_studies() {
	return array(
		...
		array(
			...
			'type'            => null,
			'desc'            => 'A sunset beachfront setting turned into a steady flow of table reservations, through paid media and tracking built around exactly what makes The Beach by Ours work.',
			'result'          => '14,842%',
