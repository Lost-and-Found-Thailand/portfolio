...
function ldm_get_case_studies() {
	return array(
		array(
			...
			'type'           => null,
			'desc'           => 'One of Bali\'s most recognizable cliffside dining destinations, tracked closely enough to trace every diner and event booking back to the ad spend that drove it.',
			'result'         => '32,500%',
		...
		array(
			...
			'industry'        => 'Performance Marketing &middot; Analytics &middot; Conversion Tracking',
			'type'            => null,
			'desc'            => 'Fine dining by evening, late-night energy after dark: Tabu Bali needed a paid media system built to keep both sides of that concept full.',
			'result'          => '7,244%',
		...
		array(
			...
			'industry'        => 'Performance Marketing &middot; Analytics &middot; Conversion Tracking',
			'type'            => 'Restaurant',
			'desc'            => 'All-day dining, converted into a steady flow of table reservations through a full-funnel paid media system built around Ours Bali\'s concept.',
			'result'          => '7,094%',
		...
		array(
			...
			'desc'              => 'One of Nusa Penida\'s most recognized beachfront spots, kept booked through paid media built to reach a harder-to-access island.',
			'result'            => '3,233%',
			'img'               => 'penida-colada-photo.jpg',
			'alt'               => 'Aerial view of the palm-shaded beachfront dining deck at Penida Colada overlooking the ocean',
			'href'              => null,
			'hero_img'          => 'penida-colada-hero.jpg',
			'challenge_title' => 'A remote-island location made trackable marketing more important, not less.',
			'challenge_body'  => 'Penida Colada is a beachfront restaurant and bar on the north shore of Nusa Penida, Bali, serving a Modern Australian-Indonesian menu with nightly live music. It has grown into one of the island\'s most recognized dining spots, but being off the main Bali tourist strip means it can\'t rely on passing foot traffic. It needed a paid media system built to turn its ocean-view setting into a steady, trackable stream of bookings.',
			'strategy_title'  => 'Full-funnel marketing built for bookings, not just clicks.',
			...
			'gallery'         => array(
				array( 'img' => 'penida-colada-gallery-1.jpg', 'alt' => 'Guests being led to their table through Penida Colada\'s thatched-roof dining area' ),
				array( 'img' => 'penida-colada-gallery-2.jpg', 'alt' => 'An overhead shot of a grilled platter, rice and cocktails served at Penida Colada' ),
		...
		array(
			...
			'industry'          => 'Performance Marketing &middot; Analytics &middot; Conversion Tracking',
			'type'              => 'Yoga School',
			'desc'              => 'Multiple campuses, one enrollment funnel: interest in House of Om converts into qualified training package enrollments and room bookings through full-funnel paid media and tracking.',
			'result'            => '2,243%',
			...
			'href'              => null,
			'challenge_title' => 'A multi-campus yoga school and resort needed one system to fill every campus, not just the flagship.',
			'challenge_body'  => 'House of Om is a yoga teacher training organization and resort running multiple campuses across Bali, Rishikesh and Koh Phangan, with an online academy that has educated over 10,000 students. Growing across that many locations meant the school needed a paid media system built to turn interest into a steady, trackable stream of training package enrollments and room bookings at every campus.',
			'strategy_title'  => 'Full-funnel marketing built for package enrollments, not just clicks.',
			'strategy_intro'  => 'Three connected workstreams built to turn House of Om\'s reputation into qualified training package enrollments.',
			'strategy_steps'  => array(
				...
				array( 'title' => 'Full-Funnel Marketing', 'desc' => 'Connecting every stage from first ad view through to training package enrollment, not just optimizing for clicks.' ),
				array( 'title' => 'Conversion Rate Optimization', 'desc' => 'Ongoing testing of the enquiry and booking flow to convert more of that attention into qualified training package enrollments.' ),
			),
			'gallery'         => array(
		...
		array(
			...
			'result'            => '615%',
			'img'               => 'burnt-photo.jpg',
			'alt'               => 'Aerial view of Burnt\'s clifftop dining deck and lounge area overlooking the ocean',
			'href'              => null,
			...
			'gallery'         => array(
				array( 'img' => 'burnt-gallery-1.jpg', 'alt' => 'An ocean-view lounge seating area at Burnt with a fire pit' ),
		...
		array(
			...
			'alt'             => 'The terracotta-toned dining room at Ama by Ours, styled with pottery in arched wall niches',
			'href'            => null,
			...
			'gallery'         => array(
				array( 'img' => 'ama-by-ours-gallery-1.jpg', 'alt' => 'Guests dining at Ama by Ours\' open-air bar and terrace' ),
				array( 'img' => 'ama-by-ours-gallery-2.jpg', 'alt' => 'A server bringing food to a table of diners at Ama by Ours' ),
				array( 'img' => 'ama-by-ours-gallery-3.jpg', 'alt' => 'A Greek meze spread of feta, olives and flatbread at Ama by Ours' ),
			),
		),
		array(
