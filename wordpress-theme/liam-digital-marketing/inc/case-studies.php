...
function ldm_get_case_studies() {
	return array(
		array(
			...
			'type'           => null,
			'desc'           => 'One of Bali\'s most recognizable cliffside dining destinations, tracked closely enough to trace every diner and event booking back to the ad spend that drove it, in high season and low.',
			'result'         => '32,500%',
		...
		array(
			...
			'industry'        => 'Performance Marketing &middot; Analytics &middot; Conversion Tracking',
			'type'            => null,
			'desc'            => 'Fine dining by evening, late-night club energy after dark: Tabu Bali\'s supper club concept needed a paid media system built to keep every side of that range full, not just one.',
			'result'          => '7,244%',
		...
		array(
			...
			'industry'        => 'Performance Marketing &middot; Analytics &middot; Conversion Tracking',
			'type'            => 'Restaurant',
			'desc'            => 'All-day dining at Ours Bali, from breakfast through to late dinner, converted into a steady flow of table reservations through a full-funnel paid media system built around that concept.',
			'result'          => '7,094%',
		...
		array( 'slug' => 'tirtha-bali', 'name' => 'Tirtha Bali', 'badge' => 'Luxury Weddings', 'industry' => 'Paid Media &middot; Lead Generation &middot; Conversion Tracking', 'type' => null, 'desc' => 'Tirtha Bali was drawing broad interest from paid social that wasn\'t the right fit for a luxury international wedding venue. Targeted paid media and full-funnel tracking turn that into higher-quality wedding enquiries.', 'result' => '3,628%', 'img' => 'tirtha-bali.jpg', 'alt' => 'Aerial view of the Tirtha Bali clifftop wedding venue', 'href' => 'case-study.html' ),
		array(
		...
		array(
			...
			'industry'          => 'Performance Marketing &middot; Analytics &middot; Conversion Tracking',
			'type'              => 'Yoga School',
			'desc'              => 'Multiple campuses, one enrollment funnel: interest in House of Om converts into qualified enrollments and room bookings through full-funnel paid media and tracking.',
			'result'            => '2,243%',
